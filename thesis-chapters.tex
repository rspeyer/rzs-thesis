...
\begin{figure}
	...
	\caption{Predicted wind speed values and corresponding ground truth values in meters/secondis shown in Figure \ref{fig:windspeedtimeseries}. Each image in Figure \ref{fig:windspeedtimeseriesimages} is associated with one of the filled markers in the plot above.}
	\label{fig:windpred}
\end{figure}
\begin{figure}
	\centering
