...
\begin{figure}
	...
	\subfigure[]{
		\includegraphics[width=0.55\textwidth]{figures/windspeedcomponents2.jpg}
...
We can now use equation \ref{eq:predict} to infer the magnitude of the wind velocity on 102 images collected between February 11 and March 17, 2009 which were not used in the training of the CCA. \textbf{RESULTS}
\begin{figure}
	\centering
	\subfigure[]{
...
\textbf{DIRECTION PREDICTIONS}
\begin{figure}
	\centering
	\subfigure[]{
		\includegraphics[width=0.55\textwidth]{figures/windspeedscatter.pdf}
		\label{fig:windspeedscatter}
	}
	\subfigure[]{
		\includegraphics[width=0.55\textwidth]{figures/decaturin.pdf}
		\label{fig:decaturin}
	}
